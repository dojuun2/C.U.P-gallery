...
public class ItemTrashCanAdapter3 extends RecyclerView.Adapter<ItemTrashCanAdapter3.ItemAlbumViewHolder> {
    private ArrayList<String> album;
    private ImageView imgPhoto;
    private static int REQUEST_CODE_PIC = 10;

    public ItemTrashCanAdapter3(ArrayList<String> album) {
        this.album = album;
    }
